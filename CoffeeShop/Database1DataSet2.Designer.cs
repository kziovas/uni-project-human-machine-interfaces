...
namespace CoffeeShop {
    ...
    public partial class Database1DataSet2 : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BooksRow AddBooksRow(string Title, string Author, decimal Price, string Details, byte[] Picture) {
        ...
        public partial class BooksRow : global::System.Data.DataRow {
            ...
            public string Details {
                get {
                    try {
                        return ((string)(this[this.tableBooks.DetailsColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Details\' in table \'Books\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableBooks.DetailsColumn] = value;
                }
            }
            ...
            public bool IsDetailsNull() {
                return this.IsNull(this.tableBooks.DetailsColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetDetailsNull() {
                this[this.tableBooks.DetailsColumn] = global::System.Convert.DBNull;
            }
...
namespace CoffeeShop.Database1DataSet2TableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Books` (`Title`, `Author`, `Price`, `Details`, `Picture`) VALUES (?," +
                " ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Books` SET `Title` = ?, `Author` = ?, `Price` = ?, `Details` = ?, `Picture` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Title` IS NULL) OR (`Title` = ?)) AND ((? = 1 AND `Author` IS NULL) OR (`Author` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CoffeeShop.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Title, Author, Price, Details, Picture FROM Books";
        ...
        public virtual int Fill(Database1DataSet2.BooksDataTable dataTable) {
        ...
        public virtual Database1DataSet2.BooksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet2.BooksDataTable dataTable = new Database1DataSet2.BooksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet2.BooksDataTable dataTable) {
        ...
        public virtual int Insert(string Title, string Author, global::System.Nullable<decimal> Price, string Details, byte[] Picture) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Author, global::System.Nullable<decimal> Price, string Details, byte[] Picture, int Original_ID, string Original_Title, string Original_Author, global::System.Nullable<decimal> Original_Price) {
            if ((Title == null)) {
