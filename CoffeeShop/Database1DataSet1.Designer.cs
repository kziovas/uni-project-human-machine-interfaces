...
namespace CoffeeShop {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public BooksRow AddBooksRow(string Title, string Author, decimal Price, string Details) {
...
namespace CoffeeShop.Database1DataSet1TableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Books` (`Title`, `Author`, `Price`, `Details`) VALUES (?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Books` SET `Title` = ?, `Author` = ?, `Price` = ?, `Details` = ? WHERE ((" +
                "`ID` = ?) AND ((? = 1 AND `Title` IS NULL) OR (`Title` = ?)) AND ((? = 1 AND `Au" +
                "thor` IS NULL) OR (`Author` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` =" +
                " ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Title, Author, Price, Details FROM Books";
        ...
        public virtual int Insert(string Title, string Author, global::System.Nullable<decimal> Price, string Details) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Author, global::System.Nullable<decimal> Price, string Details, int Original_ID, string Original_Title, string Original_Author, global::System.Nullable<decimal> Original_Price) {
            if ((Title == null)) {
