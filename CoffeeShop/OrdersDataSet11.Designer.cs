...
namespace CoffeeShop {
    ...
    public partial class OrdersDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/OrdersDataSet11.xsd";
        ...
        public partial class OrderListDataTable : global::System.Data.TypedTableBase<OrderListRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public OrderListRow FindByCustomerID(int CustomerID) {
...
namespace CoffeeShop.OrdersDataSet1TableAdapters {
    ...
    public partial class OrderListTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `OrderList` WHERE ((`CustomerID` = ?) AND ((? = 1 AND `CustomerName` IS NULL) OR (`CustomerName` = ?)) AND ((? = 1 AND `OrderDetails` IS NULL) OR (`OrderDetails` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `Status` IS NULL) OR (`Status` = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `OrderList` SET `CustomerName` = ?, `OrderDetails` = ?, `Price` = ?, `Status` = ? WHERE ((`CustomerID` = ?) AND ((? = 1 AND `CustomerName` IS NULL) OR (`CustomerName` = ?)) AND ((? = 1 AND `OrderDetails` IS NULL) OR (`OrderDetails` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `Status` IS NULL) OR (`Status` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, CustomerName, OrderDetails, Price, Status FROM OrderList";
        ...
        public virtual int Fill(OrdersDataSet1.OrderListDataTable dataTable) {
        ...
        public virtual OrdersDataSet1.OrderListDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            OrdersDataSet1.OrderListDataTable dataTable = new OrdersDataSet1.OrderListDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(OrdersDataSet1.OrderListDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CustomerID, string Original_CustomerName, string Original_OrderDetails, global::System.Nullable<decimal> Original_Price, string Original_Status) {
        ...
        public virtual int Update(string CustomerName, string OrderDetails, global::System.Nullable<decimal> Price, string Status, int Original_CustomerID, string Original_CustomerName, string Original_OrderDetails, global::System.Nullable<decimal> Original_Price, string Original_Status) {
            if ((CustomerName == null)) {
